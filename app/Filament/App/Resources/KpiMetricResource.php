...
use App\Filament\App\Resources\KpiMetricResource\Pages;
use App\Filament\App\Resources\KpiMetricResource\RelationManagers;
...
class KpiMetricResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Metric';
    protected static ?string $modelLabel = 'Metr';
