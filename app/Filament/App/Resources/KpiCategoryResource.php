...
use App\Filament\App\Resources\KpiCategoryResource\Pages;
use App\Filament\App\Resources\KpiCategoryResource\RelationManagers;
...
class KpiCategoryResource extends Resource
{
    ...
    {
        return [
            RelationManagers\KpiMetricsRelationManager::class,
        ];
    }
