...
use App\Filament\Admin\Resources\KpiDailyEntryResource\Widgets\PerformanceSummaryOverview;
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Actions\Action::make('approve')
                ...
                ->color('success')
                ->requiresConfirmation()
                ->visible(fn($record) => $record->status === 'submitted' && auth()->user()->hasRole('super_admin'))
                ->action(function() {
