...
class ReportPage extends Page implements HasForms
{
    ...
    public $dateRangeDepartment = null;
    public $dateRangeEmployee = null;
    public ?string $monthDepartment = null;
        ...
        return $form
            ->schema([
                Section::make()
                    ->columns(1)
                    ->schema([
                        Section::make('Department Filter')
                            ->description('Select the department and date filter or you can leave the department form blank to get all departments.')
                            ->columns(3)
                            ->columnSpan(1)
                            ->schema([
                                DateRangePicker::make('dateRangeDepartment')
                                    ->label('Date Range')
                                    ...
                                    ->disabled(fn(Get $get) => $get('monthDepartment') !== null),

                                Select::make('monthDepartment')
                                    ->label('Month')
                                    ...
                                    ->disabled(fn(Get $get) => $get('dateRangeDepartment') !== null),
                                ...
                                Actions::make([
                                    Action::make('printByDepartment')
                                        ->label('Print by Department')
                                        ->color('primary')
                                        ->action(fn() => $this->printByDepartment()),
                                ]),
                            ]),

                        Section::make('Employee Filter')
                            ->description('Select the employee and date filter or you can leave the employee form blank to get all employee.')
                            ->columns(3)
                            ->columnSpan(1)
                            ->schema([
                                ...
                                Actions::make([
                                    Action::make('printByEmployee')
                                        ->label('Print by Employee')
                                        ->color('primary')
                                        ->action(fn() => $this->printByEmployee()),
                                ]),
                            ]),
                    ]),
            ])
