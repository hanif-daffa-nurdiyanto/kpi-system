...
<template>
    <footer
        class="py-12 bg-gray-900 dark:bg-gray-950 text-white transition-colors duration-300"
    >
        <div class="container px-4 mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="mb-6 md:mb-0">
                    <div class="flex items-center space-x-2">
                        ...
                        <div class="relative group">
                            <img
                                :src="'/assets/kpi_logo_light.png'"
                                alt="KPI Logo Light"
                                class="h-20 block dark:hidden"
                            />
                            <img
                                :src="'/assets/kpi_logo_dark.png'"
                                alt="KPI Logo Dark"
                    ...
                    <p class="text-gray-400 dark:text-gray-500 max-w-md">
                        Empowering organizations to achieve their performance
                ...
                <div class="flex space-x-6">
                   ...
                   0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92
                   a8.19 8.19 0 01-2.357.646 4.118 4.118 
                   ...
                   0 012.8 9.713v.052a4.105 4.105 
                   0 003.292 4.022 4.095 4.095 
                   0 01-1.853.07 4.108 4.108 
                   0 003.834 2.85A8.233 8.233 
                   0 012 18.407a11.616 11.616 
                   0 006.29 1.84"
                            />
                        </svg>
                    </a>
                   ...
                   1.379.202 2.398.1 2.651.64.7 1.028 
                   1.595 1.028 2.688 0 3.848-2.339 
            ...
            <!-- Copyright -->
            <div
                class="mt-8 pt-8 border-t border-gray-800 dark:border-gray-700 text-center text-gray-400 dark:text-gray-500 text-sm"
            >
                <p>&copy; {{ currentYear }} KPI System. All rights reserved.</p>
            </div>
        </div>
    </footer>
</template>
